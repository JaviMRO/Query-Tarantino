...
def test_possessives_and_digits_close_terms(official_stopwords: frozenset[str]) -> None:
...
def test_uppercase_is_folded_and_positions_accumulate(official_stopwords: frozenset[str]) -> None:
...
def test_non_ascii_letters_close_terms(official_stopwords: frozenset[str]) -> None:
...
def test_apostrophes_and_hyphens_close_terms(official_stopwords: frozenset[str]) -> None:
...
def test_empty_text(official_stopwords: frozenset[str]) -> None:
